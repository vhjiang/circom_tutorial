...
module.exports = function builder(code, options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        var wasmModule, err_1, wc, errStr, msgStr, instance, sanityCheck;
...
var WitnessCalculator = /** @class */ (function () {
    function WitnessCalculator(instance, sanityCheck) {
        ...
        var arr = new Uint32Array(this.n32);
            ...
            return __generator(this, function (_a) {
                ...
                keys.forEach(function (k) {
                    ...
                    for (var i = 0; i < fArr.length; i++) {
                        var arrFr = toArray32(normalize(fArr[i], _this.prime), _this.n32);
